...
TELEGRAM_BOT_TOKEN = "7979146076:AAGA4DhgxgWVcdewBkaoa0ewwGWmPOv50nQ"
...
async def button_click(update: Update, context: ContextTypes.DEFAULT_TYPE):
  ...
  await query.edit_message_text(
      text=(
          ...
          f"जैसे ही EMA, SMA, Donchian, ROC कन्फर्म होगा, तुरंत यहाँ अलर्ट आएगा।"
      ),
      parse_mode="Markdown",
  )
          ...
          if isinstance(data, dict) and "d" in data:
            for item in data["d"]:
              if isinstance(item, dict) and "p" in item and "q" in item:
                ...
                # अगर वर्तमान चुने हुए पेयर का डेटा मिला
                if (
